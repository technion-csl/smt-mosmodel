...
$(MAX_ERRORS_PLOTS): $(TRAIN_ERRORS_FILE)
	$(PLOT_MAX_ERRORS_SCRIPT) --errors=$(TRAIN_ERRORS_FILE) --plot_title=$(MAX_ERRORS_PLOT_TITLE) --output=$(@D)
...
$(TRAIN_ERRORS_FILE): $(MOSMODEL_TRAIN_MEAN_CSV_FILE) $(LINEAR_MODELS_COEFFS)
	mkdir -p $(dir $@)
	$(VALIDATE_MODELS_SCRIPT) --train_dataset=$(MOSMODEL_TRAIN_MEAN_CSV_FILE) --test_dataset=$(MOSMODEL_TRAIN_MEAN_CSV_FILE) --output=$@ \
...
$(TEST_ERRORS_FILE): $(MOSMODEL_TEST_MEAN_CSV_FILE) $(MOSMODEL_TRAIN_MEAN_CSV_FILE) $(LINEAR_MODELS_COEFFS)
	mkdir -p $(dir $@)
	$(VALIDATE_MODELS_SCRIPT) --train_dataset=$(MOSMODEL_TRAIN_MEAN_CSV_FILE) --test_dataset=$(MOSMODEL_TEST_MEAN_CSV_FILE) --output=$@ \
