MODULE_NAME := experiments/subgroups_head_pages
...
CREATE_SUBGROUPS_HEAD_PAGES_LAYOUTS_SCRIPT := $(MODULE_NAME)/createLayouts.py
$(LAYOUT_FILES): $(MEMORY_FOOTPRINT_FILE) $(HOT_REGION_FILE)
	$(CREATE_SUBGROUPS_HEAD_PAGES_LAYOUTS_SCRIPT) \
